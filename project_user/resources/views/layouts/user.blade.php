...
<header class="header-section">
    <div class="header-top">
        <div class="container">
            ...
            <div class="ht-right">
                <span class="login-panel"><i class="fa fa-user"></i><a href="#" class="login">Login</a> | <a href="#" class="logout">Logout</a></span>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 text-right col-md-3">
                    <ul class="nav-right">
                        ...
                        <a href=""><i class="fa fa-shopping-cart shopping_cart"></i><span class="font_shopping_cart number_shopping_cart">0</span><span class="font_shopping_cart">Giỏ hàng</span></a>
                    </ul>
                </div>
            </div>
        </div>
